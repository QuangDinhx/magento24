<?php
namespace MGS\StoreLocator\Model\ResourceModel\Store\Grid\Collection;

/**
 * Interceptor class for @see \MGS\StoreLocator\Model\ResourceModel\Store\Grid\Collection
 */
class Interceptor extends \MGS\StoreLocator\Model\ResourceModel\Store\Grid\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addDistanceFilter');
        return $pluginInfo ? $this->___callPlugins('addDistanceFilter', func_get_args(), $pluginInfo) : parent::addDistanceFilter($data);
    }
