<?php
namespace MGS\Blog\Model\Resource\Category\Collection;

/**
 * Interceptor class for @see \MGS\Blog\Model\Resource\Category\Collection
 */
class Interceptor extends \MGS\Blog\Model\Resource\Category\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addPostFilter');
        return $pluginInfo ? $this->___callPlugins('addPostFilter', func_get_args(), $pluginInfo) : parent::addPostFilter($postId);
    }
