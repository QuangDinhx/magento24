...
class Interceptor extends \MGS\Mpanel\Block\Widget\ProductTabAttr implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Catalog\Block\Product\Context $context, \Magento\Catalog\Model\ResourceModel\Product\CollectionFactory $productCollectionFactory, \Magento\Catalog\Model\Product\Visibility $catalogProductVisibility, \Magento\Framework\App\Http\Context $httpContext, \Magento\Framework\Stdlib\DateTime\DateTime $date, \Magento\Framework\ObjectManagerInterface $objectManager, \Magento\Framework\App\ResourceConnection $resource, \Magento\Framework\Url\Helper\Data $urlHelper, \Magento\Catalog\Model\ResourceModel\Product\Attribute\CollectionFactory $attributeCollection, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $productCollectionFactory, $catalogProductVisibility, $httpContext, $date, $objectManager, $resource, $urlHelper, $attributeCollection, $data);
    }
    ...
    public function getProductCollection($attribute, $categoryId)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getProductCollection', func_get_args(), $pluginInfo) : parent::getProductCollection($attribute, $categoryId);
    }
    ...
    public function getNewProduct($collection)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getNewProduct', func_get_args(), $pluginInfo) : parent::getNewProduct($collection);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAttributeProduct');
        return $pluginInfo ? $this->___callPlugins('getAttributeProduct', func_get_args(), $pluginInfo) : parent::getAttributeProduct($collection, $attribute);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTopRateProduct');
        return $pluginInfo ? $this->___callPlugins('getTopRateProduct', func_get_args(), $pluginInfo) : parent::getTopRateProduct($collection);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSaleProduct');
        return $pluginInfo ? $this->___callPlugins('getSaleProduct', func_get_args(), $pluginInfo) : parent::getSaleProduct($collection);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAttributeCollection');
        return $pluginInfo ? $this->___callPlugins('getAttributeCollection', func_get_args(), $pluginInfo) : parent::getAttributeCollection();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTitleTab');
        return $pluginInfo ? $this->___callPlugins('getTitleTab', func_get_args(), $pluginInfo) : parent::getTitleTab($attribute);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAttributeToShow');
        return $pluginInfo ? $this->___callPlugins('getAttributeToShow', func_get_args(), $pluginInfo) : parent::getAttributeToShow();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCategorySelect');
        return $pluginInfo ? $this->___callPlugins('getCategorySelect', func_get_args(), $pluginInfo) : parent::getCategorySelect();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTyleList');
        return $pluginInfo ? $this->___callPlugins('getTyleList', func_get_args(), $pluginInfo) : parent::getTyleList();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getViewMode');
        return $pluginInfo ? $this->___callPlugins('getViewMode', func_get_args(), $pluginInfo) : parent::getViewMode();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'attributeExist');
        return $pluginInfo ? $this->___callPlugins('attributeExist', func_get_args(), $pluginInfo) : parent::attributeExist($attributes);
    }
