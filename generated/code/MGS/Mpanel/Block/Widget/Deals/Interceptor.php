<?php
namespace MGS\Mpanel\Block\Widget\Deals;

/**
 * Interceptor class for @see \MGS\Mpanel\Block\Widget\Deals
 */
class Interceptor extends \MGS\Mpanel\Block\Widget\Deals implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Catalog\Block\Product\Context $context, \Magento\Framework\Url\Helper\Data $urlHelper, \Magento\Catalog\Model\ResourceModel\Product\CollectionFactory $productCollectionFactory, \Magento\Catalog\Model\Product\Visibility $catalogProductVisibility, \Magento\Framework\App\Http\Context $httpContext, \Magento\Framework\ObjectManagerInterface $objectManager, \Magento\Framework\Stdlib\DateTime\DateTime $date, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $urlHelper, $productCollectionFactory, $catalogProductVisibility, $httpContext, $objectManager, $date, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductToShow');
        return $pluginInfo ? $this->___callPlugins('getProductToShow', func_get_args(), $pluginInfo) : parent::getProductToShow();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSliderControl');
        return $pluginInfo ? $this->___callPlugins('getSliderControl', func_get_args(), $pluginInfo) : parent::getSliderControl();
    }
