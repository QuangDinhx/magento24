<?php
namespace MGS\Mpanel\Block\Widget\ProductTabCate;

/**
 * Interceptor class for @see \MGS\Mpanel\Block\Widget\ProductTabCate
 */
class Interceptor extends \MGS\Mpanel\Block\Widget\ProductTabCate implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Catalog\Block\Product\Context $context, \Magento\Catalog\Model\ResourceModel\Product\CollectionFactory $productCollectionFactory, \Magento\Catalog\Model\Product\Visibility $catalogProductVisibility, \Magento\Framework\App\Http\Context $httpContext, \Magento\Framework\Stdlib\DateTime\DateTime $date, \Magento\Framework\ObjectManagerInterface $objectManager, \Magento\Catalog\Model\CategoryFactory $categoryFactory, \Magento\Framework\App\ResourceConnection $resource, \Magento\Framework\Url\Helper\Data $urlHelper, \Magento\Catalog\Model\ResourceModel\Product\Attribute\CollectionFactory $attributeCollection, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $productCollectionFactory, $catalogProductVisibility, $httpContext, $date, $objectManager, $categoryFactory, $resource, $urlHelper, $attributeCollection, $data);
    }
    ...
    public function getProductCollection($id_category)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getProductCollection', func_get_args(), $pluginInfo) : parent::getProductCollection($id_category);
    }
    ...
    public function getAttributeProduct($collection)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getAttributeProduct', func_get_args(), $pluginInfo) : parent::getAttributeProduct($collection);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCategoryNameShow');
        return $pluginInfo ? $this->___callPlugins('getCategoryNameShow', func_get_args(), $pluginInfo) : parent::getCategoryNameShow($categoryId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCategoryToShow');
        return $pluginInfo ? $this->___callPlugins('getCategoryToShow', func_get_args(), $pluginInfo) : parent::getCategoryToShow();
    }
    ...
    public function attributeExist($attribute)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('attributeExist', func_get_args(), $pluginInfo) : parent::attributeExist($attribute);
    }
